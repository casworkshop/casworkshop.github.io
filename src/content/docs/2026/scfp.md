...
Second Call for Papers: The 1st Workshop on Computational Affective Science (CAS 2026), co-located with the Language Resources and Evaluation Conference (LREC) 2026 in Palma de Mallorca, Spain, May 11-16. 
...
---------
**NOTE**: An initial version of the Second Call for Papers, disseminated through the Corpora mailing list, differs from this one in the wording of certain sections (details on different submission types and their scopes). This page presents the updated and current version.
